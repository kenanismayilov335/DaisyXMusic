...
async def resume(_, message: Message):
    ...
    if (chat_id not in callsmusic.active_chats) or (
        ...
        await message.reply_text("❗ Heç bir şey durdurulmur!")
    else:
        callsmusic.resume(chat_id)
        await message.reply_text("⏸ davam etmək!")
...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.active_chats:
        await message.reply_text("❗ Heç nə Yoxdu !")
    else:
        try:
        ...
        await message.reply_text("❌ Yayın dayandırıldı!")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("Admin önbelleği yeniləndi❇️!")
