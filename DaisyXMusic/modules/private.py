            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ Məni Əlavə Et 🙋‍♀️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🛠 Məni Yaradan 🛠", url=f"https://t.me/{SOURCE_CODE}")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🛠 Məni Yaradan 🛠', url=f"https://t.me/{SOURCE_CODE}")],
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**🙋‍♀️Salam! Telegram qruplarının və kanalların səsli söhbətlərində musiqi oynaya bilərəm.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
